...
import com.example.newsfeed.dto.CommentsPageResponseDto;
import com.example.newsfeed.dto.CommentsRequestDto;
import com.example.newsfeed.dto.CommentsResponseDto;
...
public class CommentController {
    ...
    public ResponseEntity<?> update(@PathVariable Long commentId,
        ...
        try {
            // Service에서 "댓글 작성자만" 수정 가능하도록 권한 체크
